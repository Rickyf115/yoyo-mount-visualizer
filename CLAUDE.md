...
- **Next up: Session 4 (string realism, optional)** — Verlet/XPBD rope pinned at contact points — or skip ahead to Session 5 (element library & authoring: rolls, underpasses, string hits, slack; difficulty weights; debug view).
